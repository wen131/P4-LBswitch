...
plt.axis([1100,1800,-2,102])
plt.xlabel("Average Response Time (ms)")
plt.ylabel("CDF (%)")
plt.tight_layout()
plt.savefig('heavy-pool.eps', format='eps' ,dpi=1000)
